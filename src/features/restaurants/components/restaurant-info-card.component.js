...
export const RestaurantInfoCard = ({ restaurant = {} }) => {
  ...
  // useEffect(() => {
  //   // console.log(restaurant.hours.split("-", 2));
  //   convertTime();
  // }, []);

  // const convertTime = () => {
  //   let tempArray = restaurant.hours.split("-", 2);
  //   tempArray.map((time) => {
  //     if (parseFloat(time) < 1200) {
  //       let hours = time.slice(0, 2);
  //       let minutes = time.slice(2, 4);
  //       console.log(hours, ":", minutes, "AM", "less than 1200");
  //     } else {
  //       let hours = time.slice(0, 2);
  //       let minutes = time.slice(2, 4);
  //       console.log(hours, ":", minutes, "PM", "more than 1200");
  //     }
  //   });
  // };
  ...
  return (
    <>
      <RestaurantCardMainScreen elevation={2}>
        ...
        <Info>
          ...
          <Section>
            ...
            <SectionEnd>
              {currentlyOpen === false && <Text variant="error">CLOSED</Text>}
